<template>
  <div class="p_wrapper" style="z-index: 19999" v-if="isShow">
    <view v-if="isMask" ref="mask" catchtouchmove="true" bubble="true" class="mask" style="z-index: 20000" :style="maskStyle"
          @touchmove.stop.prevent="moveHandle" @click="clickMask" :class="[notNvueAni ? 'not_animation_show_mask' : 'not_animation_hide_mask']"></view>
...
/*      if (this.y >=600){
        this.y =this.y -(this.winH -this.y)
        console.info("setY",this.y)
      }else{
